                ...
                <CardContent className="pt-0">
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    {report.tools.map((tool, toolIndex) => (
                      <span
                        key={toolIndex}
                        className="px-2 py-1 bg-blue-600/20 border border-blue-400/30 rounded text-blue-300 text-xs"
                      >
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button
                      onClick={() => alert("Edit functionality will be added with HelloSign integration")}
                      variant="outline"
                      className="bg-slate-800 border-slate-600 text-white hover:bg-slate-700"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="bg-red-900/20 border-red-600/30 text-red-400 hover:bg-red-900/40"
                    >
